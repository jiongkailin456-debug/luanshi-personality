...
const publicFiles = ['index.html', 'style.css', 'app.js', 'access.js', 'payment.js', 'result-code.js', 'deployment-check.html'];
...
console.log('Public assets built. Local management and report tools remain outside public/.');
